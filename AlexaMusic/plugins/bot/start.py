        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/kerala_friendship) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
@app.on_message(commandpro(["/alive", "VAIDHEHI"]) & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/0c042fe91e55eed95f16b.jpg",
...
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 join 💮", url=f"https://t.me/kerala_friendship")]]
        ),
    )
